...
You will need to set your license before running the `FONEData_Downloader.ps1`. 
...
You will need to set your license before running the `FONEData_Downloader.sh`. 
